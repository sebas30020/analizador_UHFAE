"""Panel de control (PROMPT §6.2): selección de BD, selector múltiple de métricas,
...
def build_control_panel(
    ...
    return html.Div(
        ...
        children=[
            ...
            html.H4("Métricas (gráficas tipo #3)"),
            dcc.Dropdown(
                id="metrics-picker",
                options=_all_metric_options(),
                value=[],
                multi=True,
                placeholder="Elegí una o más métricas para graficar...",
            ),

            html.Hr(),
            html.Label("Reductor (solo aplica a reducción de métrica puntual)"),
            dcc.Dropdown(
                id="grouping-reducer",
                options=[
